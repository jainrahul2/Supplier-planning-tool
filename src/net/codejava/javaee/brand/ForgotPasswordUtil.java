 ...
 * 
 * 
 * public class ForgotPasswordUtil { public static void sendEmail(String host,
 * String port, final String senderEmail, String senderName, final String
 * password, String recipientEmail, String subject, String message) throws
 * AddressException, MessagingException, UnsupportedEncodingException { // sets
 * SMTP server properties Properties properties = new Properties();
 * properties.put("mail.smtp.host", host); properties.put("mail.smtp.port",
 * port); properties.put("mail.smtp.auth", "true");
 ...
 * 
 * msg.setFrom(new InternetAddress(senderEmail, senderName)); InternetAddress[]
 * toAddresses = { new InternetAddress(recipientEmail) };
 * msg.setRecipients(Message.RecipientType.TO, toAddresses);
 * msg.setSubject(subject); msg.setSentDate(new Date()); msg.setText(message);
 * 
