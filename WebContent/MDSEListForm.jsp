...
<html>
<head>
	<title class="mainHeader">Supplier Planning Tool</title>
...
<body class="animsition">
    <div class="page-wrapper">
        ...
        <h2>
        	<a href="newmdselist">Add New Entry</a>
        	&nbsp;&nbsp;&nbsp;
        	<a href="listmdselist">List All</a>
        	
        </h2>
	</center>
    <div class="mainHeader" align="center">
		<c:if test="${MDSEList != null}">
			<form action="updatemdselist" method="post">
			
        </c:if>
        <c:if test="${MDSEList == null}">
			<form action="insertmdselist" method="post">
        ...
        <table border="1" cellpadding="5"  class="table table-striped table-bordered" style="font-family:sans-serif; font-size:12px">
            <caption>
        		...
        		<c:if test="${MDSEList != null}">
        			<input id="code" maxlength="7" type="hidden"  style="text-transform:uppercase" name="code" value="<c:out value='${MDSEList.code}'  />"	/> 
        		
        		</c:if>  
        		<tr>
                <th>Code: </th>
                <td>
                	<input id="code"  name="code" size="45" maxlength="7"  style="text-transform:uppercase"
                			value="<c:out value='${MDSEList.code}'/>"  onmouseleave="validate(this)" onmouseout="validationCheckForNumber(this.value)" required />
            ...
            <tr>
                ...
                <td>
                	<input type="text" name="division_number" size="45" style="text-transform:uppercase"
                			value="<c:out value='${MDSEList.division_number}' />"/>
            ...
            <tr>
                <th>Division Name: </th>
                <td>
                	<input type="text" name="division_name" size="45" style="text-transform:uppercase"
                			value="<c:out value='${fn:toUpperCase(MDSEList.division_name)}' />"/>
			 ...
			 <tr>
                <th>Entity Number: </th>
                <td>
                	<input type="text" name="entity_number" size="45" style="text-transform:uppercase"
                			value="<c:out value='${MDSEList.entity_number}' />"/>
                		
                </td>
            </tr> <tr>
                <th>Entity Name:</th>
                <td>
                	<input type="text" name="entity_name" size="45" style="text-transform:uppercase"
                			value="<c:out value='${fn:toUpperCase(MDSEList.entity_name)}' />"/>
                		
                </td>
            </tr> <tr>
                <th>SubDivision Number: </th>
                <td>
                	<input type="text" name="subdivison_number" size="45" style="text-transform:uppercase"
                			value="<c:out value='${MDSEList.subdivison_number}' />"/>
                		
                </td>
            </tr> <tr>
                <th>SubDivision Name: </th>
                <td>
                	<input type="text" name="subdivision_name" size="45" style="text-transform:uppercase"
                			value="<c:out value='${MDSEList.subdivision_name}' />"/>
            ...
            <tr>
                <th>Class: </th>
                <td>
                	<input type="text" name="cls" size="45" style="text-transform:uppercase"
                			value="<c:out value='${MDSEList.cls}' />"/>
