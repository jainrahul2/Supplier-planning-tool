    ...
    <div class="page-wrapper">
        ...
        <div class="page-container">
            ...
            <div class="main-content">
             <div class="container-fluid">
                     <div class="mainHeader" style="font-family:sans-serif;overflow:auto;font-size:12px;">
    <center>
		<h1>SupplierList</h1>
        <h2>
        	<a href="newsupplier">Add New Supplier</a>
        	&nbsp;&nbsp;&nbsp;
        	<a href="listsupplier">List All suppliers</a>
     ...
     <!-- <div class="panel">
  	...
  	<tbody>
            <c:forEach  var="supplierList" items="${supplierList}">
                ...
                <tr>
                    <td style="text-transform:uppercase"><c:out value= "${supplierList.supplier_number}"/></td>
                    <td style="text-transform:uppercase"><c:out value="${fn:toUpperCase(supplierList.rpt_supplier)}" /></td>
                    <td style="text-transform:uppercase"><c:out value="${fn:toUpperCase(supplierList.child_supplier)}" /></td>
                    <td style="text-transform:uppercase"><c:out value="${fn:toUpperCase(supplierList.origin_indicator)}" /></td>
                    <td style="text-transform:uppercase"><c:out value="${fn:toUpperCase(supplierList.major_category)}" /></td>
                    <td style="text-transform:uppercase"><c:out value="${fn:toUpperCase(supplierList.country)}" /></td>
                    <td style="text-transform:uppercase"><c:out value="${fn:toUpperCase(supplierList.ibo)}" /></td>
                    <td style="text-transform:uppercase"><c:out value="${fn:toUpperCase(supplierList.region)}" /></td>
                    <td style="text-transform:uppercase"><c:out value="${fn:toUpperCase(supplierList.supplier_plan)}" /></td>
                    <td style="text-transform:uppercase"><c:out value="${fn:toUpperCase(supplierList.grade)}" /></td>
                    <td style="text-transform:uppercase"><c:out value="${fn:toUpperCase(supplierList.status)}" /></td>
                  
                    <td>
                    	<a href="editsupplier?supplier_number=<c:out value='${supplierList.supplier_number}' />"> Edit</a>
                    	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    	<a href="deletesupplier?supplier_number=<c:out value='${supplierList.supplier_number}' />"   onclick="return confirm_click();"> Delete</a>                    	
                    </td>
