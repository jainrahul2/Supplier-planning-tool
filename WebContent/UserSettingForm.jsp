        ...
        <table border="1" cellpadding="5"  class="table table-striped table-bordered" style="font-family:sans-serif; font-size:12px">
            <caption>
                ...
                <td>
                	...
                	<input type="text" style="text-transform:uppercase"  name="email_id" size="45" 
                			value="<c:out value='${UserSetting.email_id}'  />" />
                ...
                <th>Old Password: </th>
                <td>
                	<input type="password" style="text-transform:uppercase" name="oldpassword" size="45"
                			value="<c:out value='${UserSetting.oldpassword}'  />"    readonly />
            ...
            <tr>
                ...
                <td>
                	<input type="password" name="newpassword" size="45" 
                			value="<c:out value='${UserSetting.newpassword}'  />" />
            ...
            <tr>
                ...
                <td>
                	<input type="password" size="45"  name="confirmpassword"
                			value="<c:out value='${UserSetting.confirmpassword}'  />" />
            ...
            <tr>
            	<td colspan="2" align="center">
            		<input type="submit" value="Save" onclick="checkpassword(document.getElementsByName('newpassword').value,document.getElementsByName('confirmpassword').value);"   />
            	</td>
            </tr>
        </table>
