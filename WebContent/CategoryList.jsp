     ...
     <!-- <div class="panel">
  	...
  	<tbody>
            <c:forEach  var="CategoryList" items="${CategoryList}">
                ...
                <tr>
                    <td><c:out  value= "${fn:toUpperCase(CategoryList.category_number)}"/></td>
                    <td><c:out value="${fn:toUpperCase(CategoryList.major_category)}" /></td>
                    <td><c:out value="${fn:toUpperCase(CategoryList.sourcing_category)}" /></td>
                    <td><c:out  value="${fn:toUpperCase(CategoryList.sourcing_sub_category)}" /></td>
                    <td><c:out  value="${fn:toUpperCase(CategoryList.classification)}" /></td>
                  	<td><c:out  value="${fn:toUpperCase(CategoryList.status)}" /></td> 
                  	
                    <td>
                    	<a href="editcat?category_number=<c:out value='${CategoryList.category_number}' />"> Edit</a>
                    	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    	<a href="deletecat?category_number=<c:out value='${CategoryList.category_number}' />" onclick=" return confirm_click();"> Delete</a>                    	
                    </td>
