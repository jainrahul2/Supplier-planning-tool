...
<body class="animsition">
    ...
    <div class="mainHeader" align="center"  style="font-family:sans-serif;overflow:auto;">
		<c:if test="${LockingDate != null}">
			<form action="updatelockingdate" method="post">
			<c:set var = "user" scope = "session" value="${fn:toUpperCase(LockingDate.updated_by)}" />
        </c:if>
        <c:if test="${LockingDate == null}">
			<form action="insertlockingdate" method="post">
  	...
  	<tbody>			
               <tr>
                ...
                <td>
                	<input type="text" name="year" size="45" maxlength="4" value="<c:out value='${LockingDate.year}' />"  required  />
                			
                </td>
                
                <td>
                	<input type="text"  id="datepicker14" name="feb" size="45" 
                			value="<c:out value='${LockingDate.feb}'  />"  readonly />		
                </td>
           		
           		
                <td>
                	<input id="datepicker2"  type="text" name="mar" size="45"
                			value="<c:out value='${LockingDate.mar}'  />"  readonly  />
                		
                </td>
            
                <td>
                	<input id="datepicker3"  type="text" name="april" size="45"
                			value="<c:out value='${LockingDate.april}' />" readonly />
                		
                </td>
           		
                <td>
                	<input id="datepicker4"  type="text" name="may" size="45"
                			value="<c:out value='${LockingDate.may}' />" readonly />
                		
                </td>
                <td>
                	<input id="datepicker5"  type="text" name="june" size="45"
                			value="<c:out value='${LockingDate.june}' />" readonly />
                </td>
             <td>
                	<input id="datepicker7"  type="text" name="july" size="45"
                			value="<c:out value='${LockingDate.july}' />" readonly />
                		
                </td>
                
                <td>
                	<input id="datepicker8"  type="text" name="august" size="45"
                			value="<c:out value='${LockingDate.august}' />" readonly />
                		
                </td>
           
                <td>
                	<input id="datepicker9"  type="text" name="september" size="45"
                			value="<c:out value='${LockingDate.september}' />" readonly />
                		
                </td>
           
                <td>
                	<input id="datepicker10"  type="text" name="october" size="45"
                			value="<c:out value='${LockingDate.october}' />" readonly />
                		
                </td>
            
                <td>
                	<input id="datepicker13"  type="text" name="november" size="45"
                			value="<c:out value='${LockingDate.november}' />" readonly />
                		
                </td>
                <td>
                	<input id="datepicker11"  type="text" name="december" size="45"
                			value="<c:out value='${LockingDate.december}' />" readonly />
               </td>
           
                <td>
                	<input id="datepicker12"  type="text" name="january" size="45"
                			value="<c:out value='${LockingDate.january}' />" readonly />
