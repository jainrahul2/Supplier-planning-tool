...
<body class="animsition">
    ...
    <center class="mainHeader">
        ...
        <h2 style="font-family:sans-serif;">
        	<a href="newcontroloffice">Add New Office</a>
        	&nbsp;&nbsp;&nbsp;
        	<a href="controllist">List All Office</a>
     ...
     <!-- <div class="panel">
  	...
  	<tbody>
            <c:forEach  var="ControlList" items="${ControlList}">
				
                <tr>
                	<td><c:out value="${fn:toUpperCase(ControlList.id)}" /></td>
                    <td><c:out value= "${fn:toUpperCase(ControlList.control_office)}"/></td>
                    <td><c:out value="${fn:toUpperCase(ControlList.region)}" /></td>
                    <td><c:out value="${fn:toUpperCase(ControlList.status)}" /></td>
                 	
                    <td>
                    	<a style="font-family:sans-serif;" href="editcontroloffice?id=<c:out value='${ControlList.id}' />"> Edit</a>
                    	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    	<a  style="font-family:sans-serif;"href="deletecontroloffice?id=<c:out value='${ControlList.id}' />"   onclick=" return confirm_click();"> Delete</a>                    	
                    </td>
                </tr>
