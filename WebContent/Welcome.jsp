        ...
        <form action="UploadServlet" method="post" enctype="multipart/form-data">
            <table width="400px" align="center" border=2>
                ...
                <tr>
                    <td>File Type </td>
                    <td>
                        <input style="width:100%" type="text" required="" name="FDP" value="FDP" readonly>
                    </td>
                </tr>
                <tr>
                    <td>Locking Date </td>
                ...
                <th>Sourcing Director: </th>
                	<td>
                		<select   style="font-family:sans-serif;" name="sourcing_director" id="sourcing_director">
        					<option name="Jerry Schroeder" value="Jerry Schroeder">Jerry Schroeder</option>
       						<option  name="John Crowley" value="John Crowley">John Crowley</option>
       						<option  name="Lisa Miller" value="Lisa Miller">Lisa Miller</option>
       						<option  name="Mike Stang" value="Mike Stang">Mike Stang</option>
       						<option  name="" value="">NO Sourcing Director</option>
       						<option  name="Robert Tejada" value="Robert Tejada">Robert Tejada</option>
       						<option  name="Samantha Kaiser" value="Samantha Kaiser">Samantha Kaiser</option>
       						<option  name="Sharyn Lindblad" value="Sharyn Lindblad">Sharyn Lindblad</option>
 						</select>
                	</td>
            </tr> 
                <tr>
