...
<body class="animsition">
    <div class="page-wrapper">
      ...
      <center class="mainHeader">
        ...
        <h2>
        	<a href="newcontroloffice">Add New Control Office</a>
        	&nbsp;&nbsp;&nbsp;
        	<a href="controllist">List All Control Office</a>
        	
        </h2>
	</center>
    <div class="mainHeader" align="center">
		<c:if test="${ControlList != null}">
			<form action="updatecontroloffice" method="post">
			
        </c:if>
        <c:if test="${ControlList == null}">
			<form action="insertcontroloffice" method="post">
        ...
        <table border="1" cellpadding="5"  class="table table-striped table-bordered" style="font-family:sans-serif; font-size:12px">
            <caption>
            	<h2 style="font-family:sans-serif;">
            		...
            		<c:if test="${ControlList == null}">
            			Add New Control Office
            		</c:if>
            	</h2>
            </caption>
        		<c:if test="${ControlList != null}">
        			<input  maxlength="7" type="hidden"  style="text-transform:uppercase" name="id" value="<c:out value='${ControlList.id}'  />"	/> 
        		
        		</c:if>  
        		<tr>
                <th>ID: </th>
                <td>
                	<input id="id" style="text-transform:uppercase" name="id" size="45" maxlength="7" 
                			value="<c:out value='${ControlList.id}'  />" />
            ...
            <tr>
                ...
                <td>
                	<input type="text" name="control_office" size="45" style="text-transform:uppercase"
                			value="<c:out value='${fn:toUpperCase(ControlList.control_office)}' />"/>
            ...
            <tr>
                ...
                <td>
                	<input type="text" name="region" size="45" style="text-transform:uppercase"
                			value="<c:out value='${fn:toUpperCase(ControlList.region)}' />"/>
