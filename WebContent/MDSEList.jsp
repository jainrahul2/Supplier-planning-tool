...
<body class="animsition">
    ...
    <center class="mainHeader">
     ...
     <!-- <div class="panel">
  	...
  	<tbody>
            <c:forEach  var="MDSEList" items="${MDSEList}">
				
                <tr>
                    <td><c:out value= "${MDSEList.code}"/></td>
                    <td><c:out value="${MDSEList.division_number}" /></td>
                    <td><c:out value="${fn:toUpperCase(MDSEList.division_name)}" /></td>
                    <td><c:out value="${MDSEList.entity_number}" /></td>
                     <td><c:out value="${fn:toUpperCase(MDSEList.entity_name)}" /></td>
                    <td><c:out value="${MDSEList.subdivison_number}" /></td>
                    <td><c:out value="${fn:toUpperCase(MDSEList.subdivision_name)}" /></td>
                    <td><c:out value="${fn:toUpperCase(MDSEList.cls)}" /></td>
                    <td><c:out value="${fn:toUpperCase(MDSEList.status)}" /></td>
                    
                 	
                    <td>
                    	<a style="font-family:sans-serif;" href="editmdselist?code=<c:out value='${MDSEList.code}' />"> Edit</a>
                    	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    	<a style="font-family:sans-serif;" href="deletemdselist?code=<c:out value='${MDSEList.code}' />"   onclick=" return  confirm_click();"> Delete</a>                    	
                    </td>
                </tr>
