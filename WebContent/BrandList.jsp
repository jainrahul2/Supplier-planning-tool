    ...
    <div class="page-wrapper">
        ...
        <div class="page-container">
            ...
            <div class="main-content">
             <div class="container-fluid">
                     <div class="mainHeader" style="font-family:sans-serif;">
        ...
        <table  id="example" class="table table-striped table-bordered" style="font-family:sans-serif;font-size:12px">
  	...
  	<tbody>
            <c:forEach  var="BrandList" items="${BrandList}">
                ...
                <tr>
                    <td><c:out value= "${BrandList.brand_number}"/></td>
                    <td><c:out value="${fn:toUpperCase(BrandList.rpt_brand)}" /></td>
                    <td><c:out value="${fn:toUpperCase(BrandList.child_brand)}" /></td>
                    <td><c:out value="${fn:toUpperCase(BrandList.brand_type)}"   /></td>
                    <td><c:out value="${fn:toUpperCase(BrandList.status)}" /></td>
                 	
                    <td>
                    	<a style="font-family:sans-serif;" href="edit?brand_number=<c:out value='${BrandList.brand_number}' />?status=<c:out value='${BrandList.status}'/>" > Edit</a>
                    	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    	<a  style="font-family:sans-serif;"href="delete?brand_number=<c:out value='${BrandList.brand_number}' />"   onclick=" return confirm_click();"> Delete</a>                    	
                    </td>
                </tr>
