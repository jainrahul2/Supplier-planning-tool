        ...
        <thead>
            ...
            <tr>	
                ...
                <% 
 					...
 					{%>
 						<td><a id="<%=rs.getString(4)%>" href="DownloadServlet?fileName=<%=rs.getString(4)%>"  target="_blank">Download</a></td>
 					<% }
 					else
 					{%>
 						<td><a id="<%=rs.getString(4)%>" href="DownloadServletSuccess?fileName=<%=rs.getString(4)%>" target="_blank">Download</a></td>
 				<%	}
