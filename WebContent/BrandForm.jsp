...
<body class="animsition">
    ...
    <div class="mainHeader" align="center">
		<c:if test="${BrandList != null}">
			...
			<c:set var = "BrandType" scope = "session" value="${fn:toUpperCase(BrandList.brand_type)}" />
        </c:if>
        <c:if test="${BrandList == null}">
			<form action="insert" method="post">
			<c:set var = "BrandType" scope = "session" value='<%=request.getParameter("brand_type")%>' />
        </c:if>
        ...
        <table border="1" cellpadding="5"  class="table table-striped table-bordered" style="font-family:sans-serif; font-size:12px">
            <caption>
        		...
        		<c:if test="${BrandList != null}">
        			<input style="text-transform:uppercase" maxlength="7" type="hidden" name="brand_number" value="<c:out value='${BrandList.brand_number}'  />"	/> 
        		
        		</c:if>  
        		<tr>
                <th>Brand Number: </th>
                <td>
                	<input style="text-transform:uppercase" id="brand_number"  name="brand_number" size="45" maxlength="7" 
                			value="<c:out value='${BrandList.brand_number}'  />"  onmouseleave="validate(this)" onmouseout="validationCheckForNumber(this.value)" required />
                			
                </td>
                
            </tr>          
            <tr>
                <th>Reporting Brand: </th>
                <td>
                	<input type="text" name="rpt_brand" size="45" style="text-transform:uppercase"
                			value="<c:out value='${fn:toUpperCase(BrandList.rpt_brand)}' />"/>
            ...
            <tr>
                <th>Child Brand: </th>
                <td>
                	<input type="text" name="child_brand" size="45" style="text-transform:uppercase"
                			value="<c:out value='${fn:toUpperCase(BrandList.child_brand)}' />"/>
             ...
             <tr>
                <th>Brand Type: </th>
                <td>
   <select style="font-family:sans-serif;" name="brand_type" value="<c:out value = "${BrandType}"/> ">
        <option id='ex' value="EXCLUSIVE">E:EXCLUSIVE</option>
        <option  id='nat 'value="NATIONAL">N:NATIONAL</option>
        <option id='pri' value="PRIVATE">P:PRIVATE</option>
    </select>
            ...
            <tr>
                <th>Status: </th>
                <td>
                	<select style="font-family:sans-serif;" name="status"  value="<c:out value='${BrandList.status}' />"  >
