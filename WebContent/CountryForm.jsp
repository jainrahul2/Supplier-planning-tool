...
<body class="animsition">
    <div class="page-wrapper">
        ...
        <h2>
        	<a href="newcountry">Add New Country</a>
        	&nbsp;&nbsp;&nbsp;
        	<a href="countrylist">List All Country</a>
    ...
    <div class="mainHeader" align="center">
		<c:if test="${CountryList != null}">
			...
			<c:set  var = "status" scope = "session" value="${fn:toUpperCase(CountryList.status)}" />
        </c:if>
        <c:if test="${CountryList == null}">
			<form action="insertcountry" method="post">
			<c:set  var = "status" scope = "session" value='<%=request.getParameter("status")%>' />	
        </c:if>
        ...
        <table border="1" cellpadding="5"  class="table table-striped table-bordered" style="font-family:sans-serif; font-size:12px">
            <caption>
        		...
        		<c:if test="${CountryList != null}">
        			<input  type="hidden" name="country_code" style="text-transform:uppercase" value="<c:out value='${CountryList.country_code}'  />"	/> 
        		
        		</c:if>  
        		<tr>
                <th>Country Code: </th>
                <td>
                	<input   id="country_code"  name="country_code"  style="text-transform:uppercase"
                			value="<c:out value='${CountryList.country_code}'  />"  required />
            ...
            <tr>
                <th>Country Name: </th>
                <td>
                	<input id="country_name"  name="country_name"  style="text-transform:uppercase"
                			value="<c:out value='${CountryList.country_name}'  />"  required />
            ...
            <tr>
                <th>Status: </th>
                	<td>
                		<select   style="font-family:sans-serif;" name="status"  value="<c:out value = "${status}"/> ">
