    ...
    <center class="mainHeader">
  	...
  	<tbody>
            <c:forEach  var="UserList" items="${UserList}">
                ...
                <tr>
                    <td><c:out value= "${fn:toUpperCase(UserList.user_id)}" /></td>
                    <td><c:out value="${fn:toUpperCase(UserList.first_name)}" /></td>
                    <td><c:out value="${fn:toUpperCase(UserList.last_name)}" /></td>
                    <td><c:out value="${fn:toUpperCase(UserList.email_id)}" /></td>
                    <td><c:out value="${fn:toUpperCase(UserList.contact_number)}" /></td>
                    <td><c:out value="${fn:toUpperCase(UserList.role)}" /></td>
                    <td><c:out value="${fn:toUpperCase(UserList.category)}" /></td>
                    <td><c:out value="${fn:toUpperCase(UserList.supporting)}" /></td>
                    
                    <td><c:out value="${fn:toUpperCase(UserList.status)}" /></td>
                 	
                    <td>
                    	<a href="edituser?user_id=<c:out value='${UserList.user_id}' />"> Edit</a>
                    	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    	<a href="deleteuser?user_id=<c:out value='${UserList.user_id}' />"   onclick="return confirm_click();"> Delete</a>                    	
                    </td>
                </tr>
