...
<body class="animsition">
    ...
    <center>
     ...
     <!-- <div class="panel">
  	...
  	<tbody>
            <c:forEach  var="FiscalCalendar" items="${FiscalCalendar}">
				
                <tr>
                    <td><c:out value= "${FiscalCalendar.year}"/></td>
                    <td><c:out value= "${FiscalCalendar.feb}"/></td>
                    <td><c:out value= "${FiscalCalendar.mar}"/></td>
                    <td><c:out value= "${FiscalCalendar.april}"/></td>
                    <td><c:out value= "${FiscalCalendar.may}"/></td>
                    <td><c:out value= "${FiscalCalendar.june}"/></td>
                    <td><c:out value= "${FiscalCalendar.july}"/></td>
                    <td><c:out value= "${FiscalCalendar.august}"/></td>
                    <td><c:out value= "${FiscalCalendar.september}"/></td>
                    <td><c:out value= "${FiscalCalendar.october}"/></td>
                    <td><c:out value= "${FiscalCalendar.november}"/></td>
                    <td><c:out value= "${FiscalCalendar.december}"/></td>
                    <td><c:out value= "${FiscalCalendar.january}"/></td>
                    <td><c:out value= "${FiscalCalendar.updated_by}"/></td>
                    <td><c:out value= "${FiscalCalendar.updated_on}"/></td>
                    <td>
                    	<a href="editfiscalcalendar?year=<c:out value='${FiscalCalendar.year}' />"> Edit</a>
                    	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    	<a href="deletefiscalcalendar?year=<c:out value='${FiscalCalendar.year}' />"  onclick=" return confirm_click();"> Delete</a>                    	
                    </td>
