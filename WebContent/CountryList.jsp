     ...
     <!-- <div class="panel">
  	...
  	<tbody>
            <c:forEach  var="CountryList" items="${CountryList}">
                ...
                <tr>
                    <td><c:out value= "${fn:toUpperCase(CountryList.country_code)}"/></td>
                    <td><c:out value="${fn:toUpperCase(CountryList.country_name)}" /></td>
                    <td><c:out value="${fn:toUpperCase(CountryList.status)}" /></td>
                 	
                    <td>
                    	<a style="font-family:sans-serif;" href="editcountry?country_code=<c:out value='${CountryList.country_code}' />"> Edit</a>
                    	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    	<a  style="font-family:sans-serif;"href="deletecountry?country_code=<c:out value='${CountryList.country_code}' />"   onclick=" return confirm_click();"> Delete</a>                    	
                    </td>
                </tr>
